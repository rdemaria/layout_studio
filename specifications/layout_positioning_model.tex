...
\author{}
\date{Prototype specification --- 7 September 2026}
...
\begin{itemize}
  ...
  \item A \emph{type} owns optional reusable mechanical geometry, optional
        magnetic geometry, and named local frames.
...
The JSON format described here is the canonical prototype format.  Readers normalize the former base-frame name \texttt{center} to
